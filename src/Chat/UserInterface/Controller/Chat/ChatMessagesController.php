...
use App\Chat\Application\Query\GetUserFriendList\GetUserFriendListQuery;
...
#[Route('/chat/mercure/chat/{id}/messages', name: 'chat_mercure_chat_messages')]
final class ChatMessagesController extends AbstractController
{
    use HandleTrait;
