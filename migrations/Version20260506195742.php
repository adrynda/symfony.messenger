...
final class Version20260506195742 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE messages (sent_at DATETIME NOT NULL, content LONGTEXT NOT NULL, id BINARY(16) NOT NULL, user_id BINARY(16) NOT NULL, chat_id BINARY(16) NOT NULL, INDEX IDX_DB021E96A76ED395 (user_id), INDEX IDX_DB021E961A9A7125 (chat_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('CREATE TABLE users (username LONGTEXT NOT NULL, avatar LONGTEXT NOT NULL, id BINARY(16) NOT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
